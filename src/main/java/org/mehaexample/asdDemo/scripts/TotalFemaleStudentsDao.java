package org.mehaexample.asdDemo.scripts;
...
public class TotalFemaleStudentsDao {
   ...
   * Singleton Pattern.
   *
   * @return Total Female StudentsPublic.
   ...
   *
   * @param totalStudents Total Female StudentsPublic (extracted from the
   ...
   *
   * @return Total Female StudentsPublic (From public database)
   * @throws SQLException when connection to the DB has something wrong.
   */
